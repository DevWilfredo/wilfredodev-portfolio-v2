  ...
  <svg {...props} fill="none" viewBox="0 0 90 91">
    <g clipPath="url(#appwrite__a)">
      ...
      <g opacity=".9">
        ...
        <g filter="url(#appwrite__c)" opacity=".55">
          <path
            fill="#FE9567"
            fill-opacity=".8"
        ...
        <g filter="url(#appwrite__e)" opacity=".65">
          <path
            fill="#FE9567"
            fill-opacity=".8"
        ...
        <g filter="url(#appwrite__f)" style={{ mixBlendMode: "overlay" }}>
          <ellipse
            cx="51.664"
            cy="4.998"
            fill="#EDEDF0"
        ...
        <g filter="url(#appwrite__g)" style={{ mixBlendMode: "overlay" }}>
          <ellipse
            cx="40.558"
            cy="4.13"
            fill="#EDEDF0"
